    ...
    resultado = if not registrosPorPaginaValidos then
        ...
        let
            ...
            let
                ...
                Fonte = Json.Document(Web.Contents("https://api.nibo.com.br", [ RelativePath = "empresas/v1/accounts/views/balance", Query = [ #"$orderby" = Text.From(OrderBy) ], Headers=[apitoken=Token] ] ) )
            in
                Fonte,
