    ...
    resultado = if not registrosPorPaginaValidos then
        ...
        let
            ...
            let
                ...
                response = try Json.Document(Web.Contents(url, [Headers=[apitoken=Token]])) otherwise null,
            ...
            baseURL = Url,
            fonteBruta = try Json.Document(Web.Contents(baseURL, [Headers=[apitoken=Token]])) otherwise null,
